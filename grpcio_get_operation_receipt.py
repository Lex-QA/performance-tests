...
get_operation_request = GetOperationReceiptRequest(
    operation_id=make_top_up_operation_response.operation.id  # ID операции пополнения счета
)
get_operation_response: GetOperationReceiptResponse = operations_gateway_service.GetOperationReceipt(
    get_operation_request)
print('Get operation receipt response:', get_operation_response)
