...
class SeedAccountResult(BaseModel):
    ...
    Attributes:
        ...
        transfer_operations (list[SeedOperationResult]): План по созданию операций перевода.
        cash_withdrawal_operations (list[SeedOperationResult]): План по созданию операций снятия.
    """
    account_id: str
